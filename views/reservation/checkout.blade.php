					...
					@if ($model->Type == 1)
						...
						<div class="col-md-12">
							<div class="row">
								...
								@endif
								<br/>
								<span>{{ trans('checkout.booked_to') }} {{ ($detail->PreferedDate != null ? $detail->PreferedDate->format('F j, Y') : "Open data") }} {{ trans('checkout.at_time') }} {{ ($detail->PreferedTime != null ? $detail->PreferedTime->format('h:m a') : "Open time") }}, {{ $detail->CustomerName }}</span>
								<br/>
