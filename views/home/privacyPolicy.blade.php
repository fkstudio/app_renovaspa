...
@section('content')
    <div class="container-fluid">
        ...
        <hr/>
        <p>This Privacy Policy governs the manner in which Renova Spa collects, uses, maintains and discloses information collected from users (each, a "User") of the www.renovaspa.com website ("Site"). This privacy policy applies to the Site and all products and services offered by Renova Spa.</p>
        <br/>
        ...
        <p>Renova Spa may collect and use Users personal information for the following purposes:</p>
        ...
        <p>Renova Spa has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        <br/>
        ...
        <p>
			...
			www.renovaspa.com<br/>
			Avd. Estados Unidos Plaza Progreso, L-21. Bávaro Punta Cana, Dominican Republic<br/>
			+1 8095521435<br/>
			nfo@renovaspa.com<br/>
			This document was last updated on June 03, 2014<br/>
