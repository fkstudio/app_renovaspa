...
@section('content')
    <div class="container-fluid container-fluid-full" style="background: url({{ URL::to('/images') }}/spa_etiquette.jpg);background-size: cover;">
    	<div class="container" style="height:600px;">
    		<div class="row" style="text-align: center;">
    			<h3 class="about-title">spa etiquette</h3>
    		</div>
    	</div>
    </div>
    <div class="container-fluid">
    	<div class="container about-container" style="height:180px;">
    		<div class="row" style="text-align: center;">
    			<br/>
    			<br/>
			    <p style="text-align: center;">Prepare yourself for the ultimate spa experience through our treatments and services oriented to relaxation, pampering and comfort, by our well trained therapists.<br>Here are some recommendations you may want to consider when having a spa service:</p>
    		</div>
    	</div>
    </div>
    <div class="container-fluid">
        <div class="container about-container">
            <div class="row" style="text-align: center !important;">
                <h3 class="history-title">GET TO KNOW ABOUT US</h3>
    ...
    <div class="container-fluid">
        <div class="container about-container">
            <div class="row" style="text-align: center !important;">
                <h3 class="history-title">BOOKING YOUR APPOINMENT</h3>
    ...
    <div class="container-fluid">
        <div class="container about-container">
            <div class="row" style="text-align: center !important;">
                <h3 class="history-title">EXPERIENCE THE SERVICE</h3>
