						...
						@if($package->WeddingPackage->Type == 2)
							<div class="package-info row">
								...
								<div class="col-md-2" style="padding-top: 10px;">
									<span style="font-size: 18px;" class="float-right">{{ $country->Currency->Symbol.number_format($package->getPlanePrice(), 2) }}</span><span style="font-size: 12px;">{{ $country->Currency->Name }}</span>
								</div>
								<div class="col-md-2">
