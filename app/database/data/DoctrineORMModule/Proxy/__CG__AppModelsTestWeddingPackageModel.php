 ...
 */
class WeddingPackageModel extends \App\Models\Test\WeddingPackageModel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WeddingPackageModel $proxy) {
