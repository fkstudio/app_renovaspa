 ...
 */
class WeddingPackageCategoryModel extends \App\Models\Test\WeddingPackageCategoryModel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WeddingPackageCategoryModel $proxy) {
