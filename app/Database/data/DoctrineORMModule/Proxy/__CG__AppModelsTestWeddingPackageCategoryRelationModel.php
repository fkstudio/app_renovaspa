 ...
 */
class WeddingPackageCategoryRelationModel extends \App\Models\Test\WeddingPackageCategoryRelationModel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WeddingPackageCategoryRelationModel $proxy) {
